...
table = cbind(c("mean before profiling", "after profiling (300 objects)", "after profiling (500 objects)" ), c("61.44432 ms", "27.24009 ms", "2.427855 s"))
...
The mean time of execution with is 27.24009 ms, which represents an improvement of approximately 56 porcentual points with respect to the non-profiled one.
...
The mean time of execution with is 1044.997 ms.
```
```{r include = TRUE, echo=FALSE}
